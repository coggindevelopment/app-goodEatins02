...
//  GoodEatins
//
//  Created by Nicholas Coggin on 2/11/19.
...
class DataSet {
    ...
    let categories = [
        ...
        FoodCategory(title: "Desserts", imageName: "dessert0")
    ]
    ...
    let desserts = [
    Recipe(title: "Mary's Cheesecake", instructions: "2 1/2 cups graham cracker crumbs. \n1/4 cup white sugar. \n1/2 cup margarine, softened. \n4 (8 oz) packages cream cheese, softened. \n 1/2 cups white sugar. \n1 pint heavy cream. \n2 tbsp all-purpose flour. \n7 eggs. \n2 tsp lemon juice. \n2 tsp vanilla extract. \nPrep: 15 m. Cook: 1 h 5 m. Ready In: 2 h. \n - Preheat oven to 350 degrees F (175 degrees C). In a medium bowl, mix graham cracker crumbs, 1/4 cup sugar and margarine until well blended. Press mixture into a 9 inch springform pan. \n - In a large bowl, beat cream cheese with sugar until smooth. \n - In a separate bowl, combine cream, flour, eggs, lemon juice and vanilla. Beat together, and then pour into cream cheese mixture. Mix well. Pour filling into prepared graham cracker crust. \n - Bake in the preheated oven for 65 minutes. Turn off oven, and cool cake in oven for 30 minutes. Prop door open and cool in oven for an additional 30 minutes. Remove from oven and cool completely. Refrigerate for as long as possible before serving.", imageName: "dessert0")
    ]
